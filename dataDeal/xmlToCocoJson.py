...
# classname_to_id = {'excavator': 1}
classname_to_id = {'house' : 1}
def get(root, name):
    ...
    def to_coco(self, xml_path_list,img_path):
        ...
        for index,xml_file in enumerate(xml_path_list):
            ...
            for obj in get(root, 'object'):
                ...
                o_width = abs(xmax - xmin) * w_ratio
                o_height = abs(ymax - ymin) * h_ratio
                # xmin *= w_ratio
                # ymin *= h_ratio
...
if __name__ == '__main__':
    # train_labelimg_path = "/home/stella/zx/mmdetection-master/data/coco/ann/train"
    # train_img_path = '/home/stella/zx/mmdetection-master/data/coco/train2017'

    test_labelimg_path = "/home/stella/zx/mmdetection-master/data/coco/ann/val"
    val_img_path = '/home/stella/zx/mmdetection-master/data/coco/val2017'
    saved_coco_path = "/home/stella/zx/mmdetection-master/data/coco/annotations/"
    # 创建文件
    ...
    print('val_n:', len(test_xml_list))


    # # 把训练集转化为COCO的json格式
    # l2c_train = Lableimg2CoCo()
    # train_instance = l2c_train.to_coco(train_xml_list,train_img_path)
    # l2c_train.save_coco_json(train_instance, '%sinstances_train2017.json'%saved_coco_path)
